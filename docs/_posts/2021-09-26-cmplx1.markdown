...
We assume that the reader is familiar with basic properties of the complex numbers $$\CC$$, both its
algebraic and analytic properties. However, we still want to highlight a few terminologies and facts
that will be useful:
...
- Definition of exp and related functions:
